...
const char* password = "mbbn6562";

// Firebase Configuration
const String FIREBASE_HOST = "iot-la11-1347-default-rtdb.firebaseio.com";
const String FIREBASE_AUTH = "yKKh2ZlH421JYwxWjhlrJlENgKUFIqQj5ce64rWK";
